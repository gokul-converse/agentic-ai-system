...
from app.models.employee_analytics_summary_models import (
    EmployeeAnalyticsSummaryRequest
)
...
def summarize_employee_analytics(
    payload: EmployeeAnalyticsSummaryRequest
):
    """
